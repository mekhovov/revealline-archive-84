...
Prepared preservation infrastructure for the exact published v0.115.1 release.

This new archive has zero previously accepted paths. Deployment, complete public-byte verification and scoped browser acceptance are pending. The donor repository and commit in input-authority.json identify the unchanged scaffold origin; donor public-acceptance records are not Archive84 evidence. The source qualification and frozen test-policy bytes retain their original historical scope.
